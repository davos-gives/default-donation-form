      ...
      <div className="flex mt-8">
        ...
        <form className="flex flex-wrap mt-4">
          <div className="border-b border-grey pb-3 w-full">
            ...
            <input className="block mt-2 capitalize text-grey-darker font-semibold pl-4 outline-none" type="text" name="number" placeholder="**** **** **** 1234" onChange={this.handleInputChange} value={this.state.number}></input>
          </div>
          ...
          <div className="border-b border-grey pb-3 mt-6 w-1/4">
            ...
            <input className="inline-block mt-2 capitalize text-grey-darker font-semibold pl-4 w-12 outline-none" type="text" name="expiryMonth" placeholder="MM" onChange={this.handleInputChange} value={this.state.expiryMonth}/> <span className="text-grey-darker"> / </span>
            <input className="inline-block mt-2 capitalize text-grey-darker font-semibold pl-4 w-12 outline-none" type="text" name="expiryYear" placeholder="YY" onChange={this.handleInputChange} value={this.state.expiryYear} />
          </div>
          ...
          <div className="border-b border-grey pb-3 mt-6 w-1/5">
            ...
            <input className="block mt-2 text-grey-darker font-semibold pl-4 w-24 outline-none" name="cvv" placeholder="123" onChange={this.handleInputChange} value={this.state.cvv}></input>
          </div>
        </form>
