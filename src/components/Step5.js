...
class Step5 extends React.Component {
  ...
  render() {
    const { donation, donor, payment, transaction } = this.props.state;
          ...
          <div className="bg-white mt-8 rounded-lg shadow-md flex self-center forced-height">
            <div className="w-2/3 p-6 mr-8 mt-8 mx-8">
              ...
              <div className="flex mt-8 mr-8">
                ...
                <div className="flex mt-2">
                  ...
                  <form className="flex flex-wrap mt-4">
                    ...
                    <div className="border-b-2 border-purple-darkest pb-3 mt-6 w-45/100">
                      ...
                      <p className="block mt-2 text-grey-darker pl-4 cursor-pointer" onClick={() => this.props.linkTo('4')}>card ending with <span className="font-semibold">{shortenCreditCard(payment.card.value)}</span></p>
                    </div>
                ...
                <div className="flex mt-2 w-full pr-8 pr-8 ml-8 pl-8 float-right">
