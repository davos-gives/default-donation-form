    ...
    return (
      <div className="mx-auto font-sans container w-3/5 mt-8">
        ...
        <div className="bg-white pt-4 flex self-center mt-8 border-t border-grey-lightest justify-between pt-8 mb-8">
          ...
          <p className="text-lg text-grey-darkest leading-normal"><span className="font-bold">Barks & Meows Shelter</span> is a community of people committed to rescuing, rehabilitating, and recolating animals to loving homes. We are located in Port Moody, B.C.</p>
          </div>
          <div className="mt-8">
