  ...
  render() {
    ...
    if(type === 'one-time') {
      ...
      if(type === currentGiftType) {
        return (
          <div className="">
            <div className="bg-orange text-white w-64 rounded-lg pt-8 text-center pb-4">
        ...
        return (
          <div className="">
            <div className="bg-white text-grey-darker w-64 rounded-lg pt-8 text-center pb-4 shadow-md" onClick={() => this.props.updateGiftType(type)}>
      ...
      if(currentGiftType !== 'one-time') {
        return (
          <div className="">
            <div className="bg-orange text-white w-64 rounded-lg pt-8 text-center pb-5">
              <span className="text-5xl font-bold block pb-2">{formatPrice(amount)}</span>
        ...
        return (
          <div className="">
            <div className="bg-white text-grey-darker w-64 rounded-lg pt-8 text-center pb-5 shadow-md" onClick={() => this.props.updateGiftType(type)}>
              <span className="text-5xl font-bold block pb-2">$</span>
