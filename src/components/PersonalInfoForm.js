      ...
      <div>
        <form className="flex flex-wrap mt-4 w-4/5 mx-auto pl-8">
          <div className="border-b border-grey pb-3 w-45/100">
            ...
            <input className="block mt-2 capitalize text-grey-darker font-semibold pl-4 outline-none" type="text" name="fname" placeholder="first name" value={this.state.fname} onChange={this.handleInputChange} />
          </div>
          ...
          <div className="border-b border-grey pb-3 mt-6 w-1/5">
            ...
            <input className="block mt-2 text-grey-darker font-semibold pl-4 w-12 outline-none" type="apt" name="street" placeholder="101" value={this.state.apt} onChange={this.handleInputChange}/>
          </div>
